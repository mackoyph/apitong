...
<h1> Footer > Follow Us</h1>
<br>
<br>
<h5>Follow us description here.... </h5>
<form method="post" target="_blank" action="function/preview.php">
<div class="col-sm-6">
	<input type="text" value="<?php echo $footertwitter ?>" placeholder="Twitter Link" class="form-control" name="content">
</div>
<br>
<br>
<br>
<div class="col-sm-6">
	<input type="text" value="<?php echo $footerfacebook ?>" placeholder="Facebook Link" class="form-control" name="content2">
</div>
...
<input type="hidden" name="content_id2" value="5">
