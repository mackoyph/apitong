...
<body class="home">
	...
	<header id="head">
		<div class="container">
			<div class="row">
				<h1 class="lead"><?php 	if(isset($_POST['content']) && isset($_POST['content_id'])) if($_POST['content_id'] == "1")  echo $_POST['content'];	 else echo $headermainname; ?></h1>
				<p class="tagline">"<?php if(isset($_POST['content']) && isset($_POST['content_id'])) if($_POST['content_id'] == "2")  echo $_POST['content'];	 else echo $headertagline; ?>"</p>
				<p><a class="btn btn-default btn-lg" role="button">MORE INFO</a> <a href="interactivity2.swf" class="btn btn-action btn-lg" target="_blank" role="button">HOME TOUR</a></p>  
			</div>
		</div>
	</header>
	<!-- /Header -->
				...
				<div class="row">
					...
					<div class="col-md-3 widget">
						...
						<div class="widget-body">
							<p><?php if(isset($_POST['content']) && isset($_POST['content_id'])) if($_POST['content_id'] == "3")  echo $_POST['content'];  else echo $footercontactnumber ?><br>
								<a href="mailto: <?php if(isset($_POST['content2']) && isset($_POST['content_id2'])) { if($_POST['content_id2'] == "8")  echo $_POST['content2']; } else echo $footercontactemail ?>"><?php if(isset($_POST['content2']) && isset($_POST['content_id2'])) { if($_POST['content_id2'] == "8")   echo $_POST['content2']; else echo $footercontactemail ; } else echo $footercontactemail ?></a><br>
								<br>
								<?php 	if(isset($_POST['content3']) && isset($_POST['content_id3'])){ if($_POST['content_id3'] == "9")  echo $_POST['content3']; else echo $footercontactaddress; }else echo $footercontactaddress ?>
							</p>	
						</div>
					</div>
					...
					<div class="col-md-3 widget">
						...
						<div class="widget-body">
							<p class="follow-me-icons">
								<a href="<?php if(isset($_POST['content']) && isset($_POST['content_id'])) if($_POST['content_id'] == "4")  echo $_POST['content']; else echo $footertwitter ?>"><i class="fa fa-twitter fa-2"></i></a>
								<a href="<?php if(isset($_POST['content2']) && isset($_POST['content_id2'])) { if($_POST['content_id2'] == "5")  echo $_POST['content2'];	else echo $footerfacebook; } else echo $footerfacebook ?>"><i class="fa fa-facebook fa-2"></i></a>
							</p>	
						</div>
					</div>
					...
					<div class="col-md-6 widget">
						...
						<div class="widget-body">
							<p><?php 	if(isset($_POST['content']) && isset($_POST['content_id'])) if($_POST['content_id'] == "7")  echo $_POST['content']; else echo $footernote ?></p>
