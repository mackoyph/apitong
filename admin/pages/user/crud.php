...
$sql = "SELECT ".$selectFields." FROM user_access";
...
<div id="wrapper">
        ...
        ?>
        <br/>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal_addUser">Add User</button>
       <br><br><br>
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                 ...
                 <form id="form" action="../admin/function/adduser.php" method="POST" enctype="multipart/form-data"  class="wizard-big">
                    <h1>Account</h1>
                    <fieldset>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <small class="font-bold">Here you can find the details of a user</small>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-lg-8">
